  ...
  <body id="paper">
    <el-form :model="loginForm" :rules="rules" class="login-container" label-position="left"
      ...
      <el-form-item style="width: 100%">
        ...
        <el-button type="primary" style="width: 40%;background: #505458;border: none" @click="reset">清空</el-button>
        <!-- <router-link to="register"><el-button type="primary" style="width: 40%;background: #505458;border: none">清空</el-button></router-link> -->
      </el-form-item>
    </el-form>
  </body>
</template>
